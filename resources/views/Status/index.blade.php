                ...
                <div class="card">
                    <div class="header">
                        ...
                        <div class="header" style=" display: flex; justify-content: space-between;">
                            ...
                            <h2>{{__('messages.active_status')}}</h2>
                            @else
                            <h2>{{__('messages.trash_status')}}</h2>
                            @endif
                            <ul class="header-dropdown dropdown dropdown-animated scale-left">
                                <li> <a href="javascript:void(0);" data-toggle="cardloading" data-loading-effect="pulse"><i class="icon-refresh"></i></a></li>
                                <li><a href="javascript:void(0);" class="full-screen"><i class="icon-size-fullscreen"></i></a></li>
                                <li> <a type="button" data-type="confirm" class="btn btn-sm btn-success js-sweetalert text-white" id="" title="Active" href="{{url('status')}}"><i class="fa fa-check-circle-o" aria-hidden="true"></i> {{__('messages.active')}}</a>
                                </li>
                                ...
                                <li> <a type="button" data-type="confirm" class="btn btn-sm btn-danger js-sweetalert text-white" id="" title="Trash" href="{{url('status-trash')}}"><i class="fa fa-trash-o" aria-hidden="true"></i> {{__('messages.trash')}}</a></li>
    ...
    $(document).on('click', '.permanently_delete', function() {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    type: "POST",
                    url: "{{url('status-permanently-delete')}}",
                    data: {
                        _token: '{{csrf_token()}}',
                        id: id
                    },
