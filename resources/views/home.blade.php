                    ...
                    <div class="row clearfix">
                            ...
                            <div class="body">
                                <div class="clearfix">
                                    ...
                                    <div class="number float-right text-right">
                                        <h6>{{__('messages.total_users')}}</h6>
                                        <span class="font700">{{$data['total_users']}}</span>
                                    </div>
                                </div>
                                <div class="progress progress-xs progress-transparent custom-color-blue mb-0 mt-3">
                                    <div class="progress-bar" data-transitiongoal="{{$data['total_users']}}"></div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="body">
                                <div class="clearfix">
                                    <div class="float-left">
                                        <i class="fa fa-2x fa-smile-o text-col-green"></i>
                                    </div>
                                    <div class="number float-right text-right">
                                        <h6>{{__('messages.active_users')}}</h6>
                                        <span class="font700">{{$data['active_users']}}</span>
                                    </div>
                                </div>
                                <div class="progress progress-xs progress-transparent custom-color-green mb-0 mt-3">
                                    <div class="progress-bar" data-transitiongoal="{{$data['active_users']}}"></div>
                                </div>
                                <!-- <small class="text-muted">19% compared to last week</small> -->
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="body">
                                <div class="clearfix">
                                    ...
                                    <div class="number float-right text-right">
                                        <h6>{{__('messages.total_shops')}}</h6>
                                        <span class="font700">{{$data['total_shops']}}</span>
                                    </div>
                                </div>
                                <div class="progress progress-xs progress-transparent custom-color-red mb-0 mt-3">
                                    <div class="progress-bar" data-transitiongoal="{{$data['total_shops']}}"></div>
                                </div>
                                <!-- <small class="text-muted">19% compared to last week</small> -->
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="body">
                                <div class="clearfix">
                                    ...
                                    <div class="number float-right text-right">
                                        <h6>{{__('messages.total_active_shop')}}</h6>
                                        <span class="font700">{{$data['total_active_shop']}}</span>
                                    </div>
                                </div>
                                <div class="progress progress-xs progress-transparent custom-color-yellow mb-0 mt-3">
                                    <div class="progress-bar" data-transitiongoal="{{$data['total_active_shop']}}"></div>
                                </div>
                                <!-- <small class="text-muted">19% compared to last week</small> -->
                            </div>
                        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div id="yearly" class="mt-2" style="height: 290px"></div>
                        <div id="monthly" class="mt-2" style="height: 290px; display:none;"></div>
