                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control @error('mobile') is-invalid @enderror" id="mobile" min="0" name="mobile" value="{{ old('mobile') }}"  autocomplete="some-unrecognised-value" placeholder="mobile" autofocus>
